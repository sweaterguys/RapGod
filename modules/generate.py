...
from six.moves import cPickle
    ...
    # MUST MATCH DIMENSIONS in NaomiCampbell.py!
def generator():

    batch_size = 15 # minibatch size
    seq_length = 15 # sequence length
    bars = 8 # number of lines to generate
    ...
    # Load vocabulary.
    with open(os.path.join('modules/save/', 'words_vocab.pkl'), 'rb') as f:
    ...
    # Generate the text.
    model = load_model('modules/save/Model.h5')
    paragraph = ['seed']
    verse = ''
    for i in range(bars):
        sentence = []
